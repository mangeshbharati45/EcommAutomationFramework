...
public class ElementUtil {
	...
	public void getElementDomAttributeVlue(By locator, String attrName) {
		nullCheck(attrName);
		getElement(locator).getDomAttribute(attrName);
	}

	public void getElementDomPropertyVlue(By locator, String propName) {
		nullCheck(propName);
		getElement(locator).getDomProperty(propName);
	}
	...
	// =========================================DropDown Utils without Select based Dropdown========================================//
	
	public boolean selectDropDownValueWithoutSelectClass(By locator, String value) {
